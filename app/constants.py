"""Quran structural constants — surah verse counts, names, and page-to-verse mapping."""
...
# Standard Madani mushaf page -> starting verse key (604 pages, 15 lines/page).
PAGE_TO_VERSE: dict[int, str] = {
    1: "1:1",
    2: "2:1",
    3: "2:6",
    4: "2:17",
